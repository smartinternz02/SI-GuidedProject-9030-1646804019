package com.example.demoeta.controller;
...
import com.example.demoeta.model.Categories;
import com.example.demoeta.model.Expenses;
import com.example.demoeta.model.User;
import com.example.demoeta.repository.BalanceRepo;
import com.example.demoeta.repository.ExpensesRepo;
import com.example.demoeta.repository.UserRepo;
...
public class ExpenseController {
	...
	public ModelAndView displayLogout(ModelAndView modelAndView, com.ambjn.expensetracker.model.User user) {
		modelAndView.addObject("user", user);
		modelAndView.setViewName("login");
		return modelAndView;
	}
